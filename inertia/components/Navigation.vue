...
<template>
    <nav class="hidden gap-5 text-sm items-center md:flex lg:gap-6">
        ...
        <Link href="/courses" class="desktop-link" :class="{ active: $page.url.startsWith('/courses') }">
            Courses
        </Link>
        ...
        <Link href="/statuses" class="desktop-link" :class="{ active: $page.url.startsWith('/statuses') }">
            Statuses
        </Link>
    ...
    <Sheet>
        <SheetTrigger as-child>
            <Button varient="outline" size="icon" class="shrink-0 md:hidden">
                <Menu class="w-5 h-5" />
        ...
        <SheetContent side="left">
            <nav class="grid gap-6 text-lg font-medium">
                ...
                <Link href="/dificulties" class="mobile-link" :class="{ active: $page.url.startsWith('/difficulties') }">
                    Difficulties
                </Link>
